...
### **Program Çıktısı ve Convergence Grafiği**

| Program Çıktısı                                                                 | Convergence Grafiği                 |
|---------------------------------------------------------------------------------|-------------------------------------|
| ![img.png](img.png) <br/> **Bulunan Rota : 12 0 10 3 5 7 9 13 11 2 6 4 8 14 1** | ![alt text](konverjans_grafigi.png) |
...
func main() {
	...
	if err := p.Save(6*vg.Inch, 4*vg.Inch, "konverjans_grafigi_%d.png"); err != nil {
		panic(err)
	}
